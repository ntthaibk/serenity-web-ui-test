package com.cb.testing.test.cb.ts.TsSingaporeModuleTest;

import com.cb.testing.model.AdminPageInputModel;
import com.cb.testing.model.CheckBoxInMenuPageModel;
import com.cb.testing.pages.cb.ts.TsSingapore.AdminTsSingPage;
...
public class TsSingaporeModuleTest {

    @Managed()
    WebDriver webDriver;

    AdminTsSingPage adminPage;
    ...
    public void cleanUpMenuBeforeTestSuite() throws InterruptedException {
        ...
        adminPage.setKeywordOwner("kfcsg");
    ...
    public void createNewRegularTalentNetwork() throws InterruptedException{
        ...
        adminPage.insertEmloyerIDToCheck("87461");
        adminPage.createRegularTalentNetWork();
        adminPage.switchToTabById(1);
        adminPage.selectOwnerTemplate("P11");
        adminPage.inputDomainName("talentsolutiondev-aiccaresg.vn");
        adminPage.inputOwnerName("aiccaresg");
        adminPage.inputReOwnerName("aiccaresg");
    ...
    public void configTalentSolutionTab() throws InterruptedException{
        ...
        adminPage.clickOnEmployerButton();
        adminPage.clickKeywordRadioButton();
        adminPage.setKeywordOwner("aiccaresg");
        adminPage.clickOnFilterButton();
    ...
    private List<CheckBoxInMenuPageModel> generateMenuCheckBoxItemToClick() {
        ...
        gioiThieu.setMenuName("About us");
        ...
        coHoiNgheNghiep.setMenuName("Career Opportunities");
