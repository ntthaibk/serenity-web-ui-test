package com.cb.testing.pages.cb.ts.TsSingapore;

import com.cb.testing.constant.TsKarieragroupOnProduction.TsSingaporeUrlConstant;
...
@Getter
public class AdminTsSingPage extends BaseTsSingPage {
    ...
    @FindBy(xpath = "//input[@type=\"radio\" and @value = \"en\"]")
    private WebElementFacade englishMenuButton;
    ...
    public void navigateAdminLoginPage() {
        String fullPageURL = TsSingaporeUrlConstant.TS_SING_HOME_PAGE + LOGIN_PATH;
        openUrl(fullPageURL);
    }
...
//        getDriver().switchTo().window(reqWindow);
    ...
    public void insertEmloyerIDToCheck(String employerID) throws InterruptedException {
        ...
        clickOn(checkEmployerIDButton);
    }

    @Step("Create regular TS")
    public void createRegularTalentNetWork() throws InterruptedException {
        WebElementFacade element = $(createTalentNetworkButton).waitUntilClickable();
        element.click();
    }
